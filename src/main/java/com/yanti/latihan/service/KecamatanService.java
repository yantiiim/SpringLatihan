...
public class KecamatanService {
    @Autowired
        ...
        public DataTablesResponse<Kecamatan> listKecamatanDataTable(DataTablesRequest req) {
            DataTablesResponse dataTableRespon  = new DataTablesResponse();
            dataTableRespon.setData(koneksiJdbc.getListKecamatan(req));
            Integer total = koneksiJdbc.getBanyakKecamatan( );
